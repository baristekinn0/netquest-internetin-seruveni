    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation: 'İnternet, tek bir bilgisayar değil; milyarlarca cihazın birbirine bağlı olduğu küresel bir ağdır. Sosyal medya ise internetin sadece küçük bir parçasıdır.',
      },
      {
        id: 'q2',
        ...
        correctIndex: 2,
        explanation: 'Modem/Router, internet servis sağlayıcından gelen bağlantıyı alır ve evdeki cihazlara dağıtır. Klavye, televizyon ve kulaklık ağ bağlantısıyla ilgili değildir.',
      },
      {
        id: 'q3',
        ...
        correctIndex: 1,
        explanation: 'Sen bir web sitesi istediğinde cihazın "istemci" rolündedir — bilgiyi talep eder. Sunucu ise bu talebi karşılayan, web sitesini barındıran bilgisayardır.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation: 'IP adresi, tıpkı posta adresi gibi cihazların birbirini tanımasını sağlar. Bir veri paketi hedefe ulaşabilmesi için hedef cihazın IP adresini bilmek zorundadır.',
      },
      {
        id: 'q2',
        ...
        correctIndex: 1,
        explanation: 'IPv4 adresleri 4 gruptan oluşur ve her grup 0-255 arasında bir sayıdır. "abc" harfler içerdiği, 999 ise 255\'i geçtiği için geçersizdir. "192.168.1.1" doğru formattadır.',
      },
      {
        id: 'q3',
        ...
        correctIndex: 1,
        explanation: '192.168.x.x aralığı, ev ve ofis ağları için ayrılmış özel (private) IP aralığıdır. Bu adresler internette görünmez, sadece yerel ağ içinde çalışır.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation: 'Veri paketi, büyük bir verinin iletim için bölündüğü küçük parçalardır. Her paket bağımsız yolculuk eder ve hedefe ulaşınca birleştirilir.',
      },
      {
        id: 'q2',
        ...
        correctIndex: 2,
        explanation: 'Router (yönlendirici), ağ trafiğini yönetir ve veri paketlerini en uygun yoldan hedefe iletir. Bir yol tıkalıysa alternatif rota bulur.',
      },
      {
        id: 'q3',
        ...
        correctIndex: 1,
        explanation: 'Her paket içinde bir sıra numarası taşır. Hedef cihaz tüm paketleri aldığında bu numaraları kullanarak doğru sırada birleştirir ve orijinal veriyi yeniden oluşturur.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation: 'Protokol, iki cihazın birbirini anlayabilmesi için uyması gereken kurallar bütünüdür. HTTP, FTP, TCP/IP gibi protokoller internetin temel taşlarıdır.',
      },
      {
        id: 'q2',
        ...
        correctIndex: 2,
        explanation: 'HTTPS = HTTP + Secure. "S" harfi "Secure" (güvenli) anlamına gelir. HTTPS, verilerinizi şifreleyerek üçüncü kişilerin okumasını engeller. Banka ve alışveriş sitelerinde zorunludur.',
      },
      {
        id: 'q3',
        ...
        correctIndex: 1,
        explanation: 'DNS (Domain Name System), "google.com" gibi insan tarafından okunabilir adresleri, bilgisayarların anladığı IP adreslerine çevirir. İnternetin telefon rehberi gibi çalışır.',
      },
    ],
  },
];
